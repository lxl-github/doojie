...
//保存
function doAdd(){
		$("#productForm").attr("action","${ctx}/system/product/save");
...
<body>
	...
	<h2>
		<img src="${ctx}/static/images/conner.jpg" width="17" height="23" hspace="5" align="absmiddle" />商品管理&gt;<font color="#FF9900">添加商品</font>
	</h2>
	<fieldset>
		<legend><strong>添加商品</strong></legend>
		...
		<div class="huibox">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" readonly="readonly" id="productCode" name="productCode" value="${productCode}"/>
					</td>
				...
				<tr>
					<td align="left">原价：</td>
					<td colspan="3">
					<input type="text" onkeyup="cal()" id="price" name="price" value=""/>
					</td>
				</tr>
				<tr>
					<td align="left">折扣：</td>
					<td colspan="3">
					<input type="text"  onkeyup="cal()" id="discount" name="discount" value=""/>注:请保留俩位小数
					</td>
				</tr>
				<tr>
					<td align="left">折扣价：</td>
					<td colspan="3">
					<input type="text"  id="disPrice" name="disPrice" value="" readonly="readonly"/>
					<input type="hidden"  id="discountPrice" name="discountPrice" value="" readonly="readonly"/>
					</td>
				</tr>
				<tr>
					<td align="left">数量：</td>
