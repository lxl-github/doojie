...
//保存
function doAdd(){
		$("#employeeForm").attr("action","${ctx}/system/employee/save");
...
<body>
	...
	<h2>
		<img src="${ctx}/static/images/conner.jpg" width="17" height="23" hspace="5" align="absmiddle" />员工管理&gt;<font color="#FF9900">添加员工</font>
	</h2>
	<fieldset>
		...
		<div class="huibox">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td colspan="3">
					<input type="text"  id="certificateNumber" name="certificateNumber" value="" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<input type="text"  onclick="new Calendar().show(this,this);" readonly="readonly"   id="entryDate" name="entryDate" value="" />
					</td>
				</tr>
				<tr>
					<td align="left">职位：</td>
				...
				<tr>
					...
					<td colspan="3">
						<input type="checkbox" onclick="selectRole()" id="isLoginSystem" name="isLoginSystem" value="1"/>
					</td>
				</tr>
