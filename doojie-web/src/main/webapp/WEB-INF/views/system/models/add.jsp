...
//保存
function doAdd(){
		$("#modelsForm").attr("action","${ctx}/system/models/save");
		if($("#modelsForm").valid()){
...
<body>
	...
	<h2>
		<img src="${ctx}/static/images/conner.jpg" width="17" height="23" hspace="5" align="absmiddle" />品牌管理&gt;<font color="#FF9900">添加型号</font>
	</h2>
	<fieldset>
		<legend><strong>添加型号</strong></legend>
