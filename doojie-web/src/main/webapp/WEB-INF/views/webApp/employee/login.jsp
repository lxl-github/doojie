...
<script type="text/javascript">
	...
	function doSubmit(){
		...
		$.post("${ctx}/webApp/ajaxCheckVerifyCode",{verifyCode:code},function(data){
			if(data){
				showLoading("登录中...");
				$.post("${ctx}/webApp/doEmployeeLogin",{userName:uname,userPwd:pwd},function(data){
					hideLoading();
					if(data == 1){
						Alert("账户不存在");
					}else if(data == 2){
						...
						Alert("登录成功");
						setTimeout(function () {
							$.cookie("isEmployeeLogin",true, { path: '${ctx}' });
							var href = $.cookie('target_employee_herf');
							if(typeof(href) == "undefined" || href == "null"){
								window.location.href = "${ctx}/webApp/employee/my";
							}else{
...
<body>
	...
	<div class="ik-ind-container">
		<span class="icon-back"><span
			...
			class="ind-title">员工登录&nbsp;</span> <span class="ind-person">&nbsp;</span>
	</div>
	</nav>
	<br />
