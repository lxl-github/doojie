...
//保存
function doAdd(){
		$("#brandForm").attr("action","${ctx}/system/brand/save");
		if($("#brandForm").valid()){
...
<body>
	...
	<h2>
		<img src="${ctx}/static/images/conner.jpg" width="17" height="23" hspace="5" align="absmiddle" />品牌管理&gt;<font color="#FF9900">添加品牌</font>
	</h2>
	<fieldset>
		<legend><strong>添加品牌</strong></legend>
		...
		<div class="huibox">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td colspan="3">
						<input type="file"  id="logoFile" name="logoFile" value=""/>
					</td>
				</tr>
				<tr>
