...
<body>
	<nav class="navbar navbar-default navbar-style" role="navigation">
	  <div class="ik-ind-container">
		...
		<span class="ind-title">我的评价&nbsp;</span>
	...
	var flag = true;
		...
		function init(pageNum) {
			...
			//循环数据
			$.post("${ctx}/webApp/user/myRecommendList",{currentPage:pageNum},function(data) {
				if(data == "-100"){
					...
					if (data.totalPage > 0) {
						...
						$(data.results).each(
								function(index) {
									...
									listContent +='<h3 class="panel-title" style="font-weight:bold;"><span class="glyphicon glyphicon-leaf"></span>&nbsp;'+recommendVo.bName+'</h3>';
									listContent +='</div>';
									listContent +='<div class="panel-body" style="background-color:#eee;">'+recommendVo.reasons+'</div>';
