...
function(e) {
    ...
    function t(e) {
        if (e) {
            ...
            for (var t, r = 0,
            i = n.length; i > r; r++) if (t = n[r] + e, "string" == typeof o[t]) return t
        }
    }
        ...
        function n() {
            if (!p) {
                ...
                if (a = function() {
                    ...
                    return function(e) {
                        var r = t(e);
                        return r || o("Style returned " + r + ". Are you running this code in a hidden iframe on Firefox? See http://bit.ly/getsizebug1"),
                        r
                    }
                } (), u = r("boxSizing")) {
...
function(e) {
    ...
    function d(d) {
        return "complete" === o.readyState ? i() : (d.bind(o, "DOMContentLoaded", n), d.bind(o, "readystatechange", n), d.bind(e, "load", n)),
        t
    }
    var o = e.document,
    a = [];
...
function(e, t, i) {
    ...
    function r(e) {
        var t = [];
        if (o(e)) t = e;
        else if ("number" == typeof e.length) for (var i = 0,
        n = e.length; n > i; i++) t.push(e[i]);
        else t.push(e);
        return t
    }
    function s(e, t, i) {
...
function(e, t) {
    "use strict";
    "function" == typeof define && define.amd ? define(["doc-ready/doc-ready", "matches-selector/matches-selector"],
    function(n, r) {
        return t(e, n, r)
...
function(e, t, n) {
    ...
    o.makeArray = function(e) {
        var t = [];
        if (o.isArray(e)) t = e;
        else if (e && "number" == typeof e.length) for (var n = 0,
        r = e.length; r > n; n++) t.push(e[n]);
        else t.push(e);
        return t
    },
...
function(t, n) {
    ...
    e.prototype.bindHandles = function(n) {
        var o;
        o = t.navigator.pointerEnabled ? this.bindPointer: t.navigator.msPointerEnabled ? this.bindMSPointer: this.bindMouseTouch,
        n = void 0 === n ? !0 : !!n;
        for (var e = 0,
        i = this.handles.length; i > e; e++) {
    ...
    e.prototype.bindPointer = function(t, o) {
        var e = o ? "bind": "unbind";
        n[e](t, "pointerdown", this),
        t.style.touchAction = o ? "none": ""
    },
    e.prototype.bindMSPointer = function(t, o) {
        var e = o ? "bind": "unbind";
        n[e](t, "MSPointerDown", this),
        t.style.msTouchAction = o ? "none": ""
    },
    e.prototype.bindMouseTouch = function(t, o) {
        var e = o ? "bind": "unbind";
        n[e](t, "mousedown", this),
        n[e](t, "touchstart", this),
        o && p(t)
    };
    var r = "attachEvent" in document.documentElement,
    p = r ?
    function(t) {
    ...
    e.prototype.pointerDown = o,
    e.prototype._bindPostStartEvents = function(t) {
        for (var o = 0,
        e = t.events.length; e > o; o++) {
            var i = t.events[o];
    ...
    e.prototype._pointerMove = function(t, n) {
        ...
        this.emitEvent("pointerMove", [this, t, n])
    },
    e.prototype.pointerMove = o,
    ...
    e.prototype._pointerUp = function(t, n) {
        ...
        this.pointerUp(t, n),
        this.emitEvent("pointerUp", [this, t, n])
    },
    e.prototype.pointerUp = o,
    e.prototype.onMSPointerCancel = e.prototype.onpointercancel = function(t) {
        t.pointerId == this.pointerIdentifier && this._pointerUp(t, t)
    },
    ...
    e.setPointerPoint = function(t, n) {
        t.x = void 0 !== n.pageX ? n.pageX: n.clientX,
        t.y = void 0 !== n.pageY ? n.pageY: n.clientY
    },
    e
}); !
function(t, e) {
...
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["./utils"],
    function(i) {
        return e(t, i)
    }) : "object" == typeof exports ? module.exports = e(t, require("./utils")) : (t.Flickity = t.Flickity || {},
    t.Flickity.PrevNextButton = e(t, t.utils))
} (window,
function(t, e) {
    "use strict";
    function i(t, e) {
    ...
    i.prototype.createSVG = function() {
        ...
        return e.setAttribute("transform", i),
        t.appendChild(e),
        t
    },
    i.prototype.setArrowText = function() {
        var t = this.parent.options,
        i = this.isLeft ? t.leftArrowText: t.rightArrowText;
    ...
    i.prototype.update = function() {
        ...
        var t = this.isPrevious ? 0 : this.parent.cells.length - 1,
        e = this.parent.selectedIndex == t ? "disable": "enable";
        this[e]()
    },
    i
}); !
function(t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["eventie/eventie", "./utils"],
    function(i, o) {
        return e(t, i, o)
    }) : "object" == typeof exports ? module.exports = e(t, require("eventie"), require("./utils")) : (t.Flickity = t.Flickity || {},
    t.Flickity.PageDots = e(t, t.eventie, t.utils))
} (window,
function(t, e, i) {
    "use strict";
    function o(t) {
...
function(t, i) {
    ...
    "function" == typeof define && define.amd ? define(function() {
        return i()
    }) : "object" == typeof exports ? module.exports = i() : (t.Flickity = t.Flickity || {},
    t.Flickity.Player = i())
} (window,
function() {
    "use strict";
...
function(t, i) {
    "use strict";
    "function" == typeof define && define.amd ? define(["./unipointer", "classie/classie", "eventie/eventie", "./utils"],
    function(e, s, n) {
        return i(t, e, s, n)
    }) : "object" == typeof exports ? module.exports = i(t, require("./unipointer"), require("desandro-classie"), require("eventie"), require("./utils")) : (t.Flickity = t.Flickity || {},
    t.Flickity.dragPrototype = i(t, t.Unipointer, t.classie, t.eventie, t.utils))
} (window,
function(t, i, e, s, n) {
    "use strict";
    function r(t) {
    ...
    return o.pointerDown = function(t, s) {
        ...
        l && l.blur && l != this.element && l.blur(),
        this.options.accessibility && "INPUT" != n && this.element.focus(),
        this.velocity = 0,
        this.pointerDownPoint = i.getPointerPoint(s),
        this.player.stop(),
        e.add(this.viewport, "is-pointer-down")
    },
    o.pointerMove = function(t, e) {
        var s = i.getPointerPoint(e),
        n = s.x - this.pointerDownPoint.x; ! this.isDragging && Math.abs(n) > 3 && this.dragStart(t, e),
        this.dragMove(s, t, e)
    },
    ...
    o.dragMove = function(t, i, e) {
        if (this.isDragging) {
            ...
            var s = t.x - this.dragStartPoint.x,
            ...
            this.dispatchEvent("dragMove", i, [e])
        }
    },
    ...
    o.dragEndRestingSelect = function() {
        ...
        i = Math.abs(this.getCellDistance( - t, this.selectedIndex)),
        e = this._getClosestResting(t, i, 1),
        s = this._getClosestResting(t, i, -1),
        n = e.distance < s.distance ? e.index: s.index;
        return n
    },
    o._getClosestResting = function(t, i, e) {
        for (var s = this.selectedIndex,
        n = 1 / 0,
        r = this.options.contain && !this.options.wrapAround ?
        function(t, i) {
            return i >= t
        }: function(t, i) {
            return i > t
    ...
    o.getCellDistance = function(t, i) {
        ...
        s = this.options.wrapAround ? n.modulo(i, e) : i,
        r = this.cells[s];
        if (!r) return null;
    ...
    o.staticClick = function(t, i) {
        "INPUT" == t.target.nodeName && "text" == t.target.type && t.target.focus(),
...
function(t, i) {
    "use strict";
    "function" == typeof define && define.amd ? define(["get-style-property/get-style-property", "./utils"],
    function(e, s) {
        return i(t, e, s)
    }) : "object" == typeof exports ? module.exports = i(t, require("desandro-get-style-property"), require("./utils")) : (t.Flickity = t.Flickity || {},
    t.Flickity.animatePrototype = i(t, t.getStyleProperty, t.utils))
} (window,
function(t, i, e) {
    "use strict";
    for (var s, n = 0,
    o = "webkit moz ms o".split(" "), r = t.requestAnimationFrame, h = t.cancelAnimationFrame, l = 0; l < o.length && (!r || !h); l++) s = o[l],
    r = r || t[s + "RequestAnimationFrame"],
    h = h || t[s + "CancelAnimationFrame"] || t[s + "CancelRequestAnimationFrame"];
    r && h || (r = function(i) {
    ...
    return a.positionSlider = function() {
        var t = this.x;
        this.options.wrapAround && (t = e.modulo(t, this.slideableWidth), t -= this.slideableWidth, this.shiftWrapCells(t)),
    ...
    a.settle = function(t) {
        ...
        this.restingFrames > 2 && (this.isAnimating = !1, delete this.isFreeScrolling, u && this.positionSlider(), this.dispatchEvent("settle"))
    },
    ...
    a._unshiftCells = function(t) {
        ...
        e = t.length; e > i; i++) t[i].wrapShift(0)
    },
    ...
    a.applySelectedAttraction = function() {
        if (!this.isPointerDown && !this.isFreeScrolling && this.cells.length) {
            var t = this.cells[this.selectedIndex],
            i = this.options.wrapAround ? this.slideableWidth * Math.floor(this.selectedIndex / this.cells.length) : 0,
            e = -1 * (t.target + i) - this.x,
            s = e * this.options.selectedAttraction;
            this.applyForce(s)
        }
    },
    a
...
function(e, t) {
    ...
    function(i) {
        return t(e, i)
    }) : "object" == typeof exports ? module.exports = t(e, require("./utils")) : (e.Flickity = e.Flickity || {},
    e.Flickity.cellChangePrototype = t(e, e.utils))
} (window,
function(e, t) {
    "use strict";
    function i(e) {
    ...
    s.cellChange = function(e) {
        ...
        this.options.freeScroll ? this.positionSlider() : this.select(this.selectedIndex)
    },
    s
}); !
function(t, e) {
    "use strict";
    if ("function" == typeof define && define.amd) define(["classie/classie", "eventEmitter/EventEmitter", "eventie/eventie", "get-size/get-size", "./utils", "./cell", "./prev-next-button", "./page-dots", "./player", "./drag", "./animate", "./cell-change"],
    function(i, s, o, n, l, r, h, a, c, p, d, u) {
        return e(t, i, s, o, n, l, r, h, a, c, p, d, u)
    });
    else if ("object" == typeof exports) module.exports = e(t, require("desandro-classie"), require("wolfy87-eventemitter"), require("eventie"), require("get-size"), require("./utils"), require("./cell"), require("./prev-next-button"), require("./page-dots"), require("./player"), require("./drag"), require("./animate"), require("./cell-change"));
    else {
        var i = t.Flickity;
...
function(t, e, i, s, o, n, l, r, h, a, c, p, d) {
    "use strict";
    function u(t, e) {
    ...
    function f(t, e) {
        ...
        return i ? (this.element = i, v && (this.$element = v(this.element)), this.options = n.extend({},
        this.constructor.defaults), this.option(e), void this._create()) : void(m && m.error("Bad element for Flickity: " + (i || t)))
    }
    var v = t.jQuery,
    g = t.getComputedStyle,
    m = t.console,
    y = t.imagesLoaded,
    C = 0,
    x = {};
    ...
    n.extend(f.prototype, i.prototype),
    f.prototype._create = function() {
        ...
        this._createSlider(),
        this.options.prevNextButtons && (this.prevButton = new r( - 1, this), this.nextButton = new r(1, this)),
        this.options.pageDots && (this.pageDots = new h(this)),
        this.player = new a(this),
        (this.options.resizeBound || this.options.watchCSS) && s.bind(t, "resize", this),
    ...
    f.prototype._positionCells = function(t) {
        ...
        for (var s, o = this.cells.length,
        n = t; o > n; n++) s = this.cells[n],
        s.setPosition(e),
        e += s.size.outerWidth,
    ...
    f.prototype._containCells = function() {
        if (this.options.contain && !this.options.wrapAround) for (var t = this.getLastCell(), e = this.options.rightToLeft ? "marginLeft": "marginRight", i = this.slideableWidth - t.size[e], s = i - this.size.innerWidth * (1 - this.cellAlign), o = 0, n = this.cells.length; n > o; o++) {
            var l = this.cells[o];
            l.setDefaultTarget(),
            l.target = Math.max(l.target, this.cursorPosition),
            l.target = Math.min(l.target, s)
        }
    },
    ...
    f.prototype.updatePrevNextButtons = function() {
        this.prevButton && this.prevButton.update(),
        this.nextButton && this.nextButton.update()
    },
    f.prototype.setSelectedCell = function() {
        this._removeSelectedCellClass(),
        this.selectedCell = this.cells[this.selectedIndex],
        e.add(this.selectedCell.element, "is-selected")
    },
    ...
    f.prototype.imagesLoaded = function() {
        function t(t, i) {
            var s = e.getCell(i.img),
            o = s.element || n.getParent(i.img, ".flickity-slider > *");
            e.cellSizeChange(o)
        }
    ...
    return f.prototype.watchCSS = function() {
        ...
        if (t) {
            ...
            var s = g(this.element, ":after").content; - 1 != s.indexOf("flickity") ? this.activate() : this.deactivate()
        }
    },
    ...
    f.prototype.onmouseenter = function() {
        this.player.pause(),
        s.bind(this.element, "mouseleave", this)
    },
    f.prototype.onmouseleave = function() {
        this.player.unpause(),
        s.unbind(this.element, "mouseleave", this)
    },
    f.prototype.deactivate = function() {
        if (this.isActive) {
            e.remove(this.element, "flickity-enabled");
            for (var t = 0,
            i = this.cells.length; i > t; t++) {
                var o = this.cells[t];
                o.destroy()
            }
            this._removeSelectedCellClass(),
            this.element.removeChild(this.viewport),
            u(this.slider, this.element),
            this.prevButton && this.prevButton.deactivate(),
            this.nextButton && this.nextButton.deactivate(),
            this.pageDots && this.pageDots.deactivate(),
            this.player.stop(),
            this.unbindDrag(),
            this.options.accessibility && (this.element.removeAttribute("tabIndex"), s.unbind(this.element, "keydown", this)),
            this.isActive = !1,
            this.isAnimating = !1
        }
    },
    f.prototype.destroy = function() {
        this.deactivate(),
        (this.options.resizeBound || this.options.watch) && s.unbind(t, "resize", this),
        delete this.element.flickityGUID,
        delete x[this.guid]
    },
    n.extend(f.prototype, c),
    n.extend(f.prototype, p),
    n.extend(f.prototype, d),
    f.data = function(t) {
    ...
    v && v.bridget && v.bridget("flickity", f),
    f.Cell = l,
    f.PrevNextButton = r,
    f.PageDots = h,
    f.Player = a,
